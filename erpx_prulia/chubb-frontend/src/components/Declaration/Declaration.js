          ...
          <Formik
            ...
            validate={values => {
              ...
              if (!values.declaration)
                errors.declaration = "Please check the box!";

              // if (!values.privacyNotice) errors.privacyNotice = 'Please check the box!';

              if (!values.paymentInstruction)
                errors.paymentInstruction = "Please check the box!";
              ...
              if (!values.issuing_bank)
                errors.issuing_bank = "Issuing bank is required";
              ...
              if (!values.card_expiry)
                ...
                parseInt(values.card_expiry.split("/").pop()) <
              ...
              if (this.state.mainSign) {
                if (this.state.mainSign.isEmpty())
                  errors.main_sign = "Signature is required";
                else {
                  this.props.gettingValues(
                    {
                      target: {
              ...
              if (this.state.cardSign) {
                if (this.state.cardSign.isEmpty())
                  errors.card_sign = "Signature is required";
                else {
                  this.props.gettingValues(
                    {
                      target: {
              ...
              <form onSubmit={handleSubmit}>
                <div className="flexDiv">
                  ...
                  <div className="content">
                    ...
                    <p>
                      I agree that the statements and declarations contained in
                      this proposal form will be relied upon by Chubb to decide
                      whether to accept this insurance. I understand that Chubb
                      needs to deal with my personal data to administer my
                      Policy and offer me insurance products and services. To
                      achieve these purposes, I allow Chubb to collect, use and
                      disclose my personal data to selected third parties in or
                      outside Malaysia, in accordance with Chubb’s Personal Data
                      Protection Notice, which is found in Chubb’s website at
                      www.chubb.com/my-privacy. I may contact Chubb for access
                ...
                <div className="flexDiv">
                  ...
                  <div className="content">
                    <h6>Declaration</h6>
                    <p>
                      I confirm that I have read the policy wordings and product
                      disclosure sheet and this product is suitable for me and
                      meets my insurance needs, financial objectives and
                      priority and hereby agree to purchase this product. Where
                      I have opted to purchase the coverage for my spouse and/or
                      my child(ren), I further confirm that this product is
                      suitable for them and meets their insurance needs,
                      financial objectives and priority and hereby agree to
                      purchase this product for their benefit.
                    </p>
                    <p1>
                ...
                <div className="flexDiv">
                  ...
                  <div className="content">
                    ...
                    <p>
                      I authorise Chubb to debit my credit card for payment of
                      the premium stated below.
                    </p>
                  </div>
                </div>
                ...
                {values.paymentInstruction && (
                  <div className="paymentDetails">
                    <div className="inputGroup">
                      <label>Name of Credit Card Holder</label>
                      <input
                        type="text"
                    ...
                    <div className="second">
                      ...
                      <div className="signDiv">
                        ...
                        <div className="group">
                          ...
                          <label>
                            Signature of Main Insured Person
                            <input
                              type="button"
                              value="Clear"
                              onClick={() => {
                                this.state.mainSign &&
                                  this.state.mainSign.clear();
                              }}
                            ></input>
                          </label>
                          <span className="error">
