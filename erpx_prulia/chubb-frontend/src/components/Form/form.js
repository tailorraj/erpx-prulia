...
class Form extends React.Component {
    ...
    _componentDidMount() {
        ...
        for (let i = 0; i < 43; i++) {
            mainInsuredNameDiv.innerHTML += `<div id="mainInsuredName${i}" class="box">${mainInsuredName[i] || ''}</div>`
        }
                ...
                <div className='page4'>
                    <div className='page4-div'>
                        ...
                        <div className="Notice">
                            ...
                            <p>
                                For all intents and purpose where there is a conflict or ambiguity as to the meaning in
                                the Bahasa Malaysia provision, it is hereby agreed that
                                the English version shall prevail.
                            </p>
                            <p>
                                <i>
                                    Bagi setiap tujuan dan maksud sekiranya terdapat konflik atau kekaburan berkenaan
                                    makna di dalam peruntukan Bahasa Malaysia, adalah
