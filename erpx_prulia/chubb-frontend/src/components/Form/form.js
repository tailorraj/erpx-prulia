...
class Form extends React.Component {
  ...
  submit = () => {
    ...
    makePDF().then(pdf_blob => {
      Object.keys(this.props.state).forEach(key => {
        ...
        function getNum(key) {
          return parseInt(
            key.replace("childName", "").replace("childBirthDate", "")
          );
        }
      });
      ...
      return uploadFile(pdf_blob)
        .then(res => {
          data.application_form =
            res && res.data && res.data.message && res.data.message.file_url;
  ...
  _componentDidMount() {
    ...
    for (let i = 0; i < 6; i++) {
      mainInsuredAddressDiv.innerHTML += `<div id="mainInsuredAddress${String(
        i
      ).replace("_", "")}" class="box">${mainInsuredPostcode[i]}</div>`;
    }
    ...
    if (mainInsuredMobileNo) {
      ...
      mainInsuredMobileNo = mainInsuredMobileNo
        .replace("+", "")
        .replace("-", " ");
      for (let i = 0; i < 15; i++) {
    ...
    if (spouseNric) {
      ...
      for (let i = 0; i < 14; i++) {
        document.getElementById(`spouseNricDiv${i}`).innerHTML = spouseNric[i];
      }
    }
    ...
    for (let i = 0; i < 19; i++) {
      if (i === 4 || i === 9 || i === 14) {
        ...
        card_numberDiv.innerHTML += `<div id="card_numberDiv${i}" class="box">${card_number[
          i
        ] || ""}</div>`;
      }
    }
    ...
    for (let i = 0; i < 7; i++) {
      if (i === 2) {
        ...
        card_expiryDiv.innerHTML += `<div id="card_expiryDiv${i}" class="box">${card_expiry[
          i
        ] || ""}</div>`;
      }
    }
    ...
    for (let i = 0; i < 10; i++) {
      paymentDateDiv.innerHTML += `<div id="paymentDateDiv${i}" class="box">${paymentDate[
        i
      ] || ""}</div>`;
    }
    ...
    for (let i = 0; i < total.length; i++) {
      totalDiv.innerHTML += `<div id="totalDiv${i}" class="box">${total[i] ||
        ""}</div>`;
    }
          ...
          <div className="form">
            ...
            <div className="Detail-customer">
              ...
              <div className="fullname">
                ...
                <div
                  id="mainInsuredName"
                  className="input-value underline uppercase"
                ></div>
              </div>
              ...
              <div id="emailDiv" className="email">
                ...
                <div id="email" className="input-value"></div>
              </div>
              <div>
                <p className="underLine">
          ...
          <div className="page3-detail">
            <p>
              ...
              *Age limit : The plan shall cover eligible persons who are not
              less than 18 years of age or more than 80 years of age (i.e. upon
              attainment of the person’s 81st birthday). Eligible child are over
              ...
              <i>
                *Had umur : Pelan ini akan melindungi orang-orang yang layak
                ...
                umur 80 tahun (iaitu apabila mencapai umur 81 tahun). Anak yang
        ...
        <div className="page4" id="page4">
          <div className="page4-div">
            ...
            <div className="contact">
              ...
              <ul>
                <li>Chubb Insurance Malaysia Berhad (9827-A)</li>
                <li>
            ...
            <div className="pdf-logo">
              <img src={`${process.env.PUBLIC_URL}/assets/files/logo.png`} />
              <h3>
            ...
            <div className="copyright-pdf">
              <p>
                © 2018 Chubb. Not all coverages available in all jurisdictions.
                Chubb©, their respective logos and Chubb.Insured.<sup>SM</sup>{" "}
                are protected trademarks of Chubb. <br />
                Published P37/09/18/V3
              </p>
            </div>
          </div>
        </div>
