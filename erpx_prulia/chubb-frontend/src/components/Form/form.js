...
class Form extends React.Component {
  ...
  componentDidMount() {
    ...
    for (let i = 0; i < 43; i++) {
      mainInsuredNameDiv.innerHTML += `<div id="mainInsuredName${i}" className="box"></div>`
    }
    if (mainInsuredName) {
    ...
    for (let i = 0; i < 113; i++) {
      mainInsuredAddressDiv.innerHTML += `<div id="mainInsuredAddress${i}" className="box"></div>`
    }
    ...
    mainInsuredAddressDiv.innerHTML += `<div className="postcode" ><p>Postcode / <i>Poskod<i/></p></div>`
    for (let i = 0; i < 6; i++) {
      mainInsuredAddressDiv.innerHTML += `<div id="mainInsuredAddress${i}" className="box"></div>`
    }
    ...
    for (let i = 0; i < 14; i++) {
      if (i !== 6 || i !== 9) {
        mainInsuredNricDiv.innerHTML += `<div id="mainInsuredNric${i}" className="box"></div>`
      }
    }
    if (mainInsuredNric) {
    ...
    for (let i = 0; i < 10; i++) {
      mainInsuredBirthDateDiv.innerHTML += `<div id="mainInsuredBirthDate${i}" className="box"></div>`
    }
    ...
    if (mainInsuredGender === 'male') {
      maleDiv.innerHTML = `<svg width="30px" height="30px" viewBox="0 0 16 16" className="bi bi-check" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10.97 4.97a.75.75 0 0 1 1.071 1.05l-3.992 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.236.236 0 0 1 .02-.022z"/></svg>`
    } else if (mainInsuredGender === 'female') {
      femaleDiv.innerHTML = `<svg width="30px" height="30px" viewBox="0 0 16 16" className="bi bi-check" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10.97 4.97a.75.75 0 0 1 1.071 1.05l-3.992 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.236.236 0 0 1 .02-.022z"/></svg>`
    }
    ...
    if (mainInsuredStatus === 'married') {
      marriedDiv.innerHTML = `<svg width="30px" height="30px" viewBox="0 0 16 16" className="bi bi-check" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10.97 4.97a.75.75 0 0 1 1.071 1.05l-3.992 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.236.236 0 0 1 .02-.022z"/></svg>`
    } else if (mainInsuredStatus === 'single') {
      singleDiv.innerHTML = `<svg width="30px" height="30px" viewBox="0 0 16 16" className="bi bi-check" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10.97 4.97a.75.75 0 0 1 1.071 1.05l-3.992 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.236.236 0 0 1 .02-.022z"/></svg>`
    ...
    for (let i = 0; i < 10; i++) {
      if (i !== 3) {
        phoneNoDiv.innerHTML += `<div id="phoneNo${i}" className="box"></div>`
      } else {
        phoneNoDiv.innerHTML += `<div className="dash">-</div>`
      }
    }
    ...
    for (let i = 0; i < 43; i++) {
      emailDiv.innerHTML += `<div id="emailDiv${i}" className="box"></div>`
    }
    if (mainInsuredEmail) {
    ...
    if (this.props.state.spouse) {
      spouseTrue.innerHTML = `<svg width="30px" height="30px" viewBox="0 0 16 16" className="bi bi-check" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10.97 4.97a.75.75 0 0 1 1.071 1.05l-3.992 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.236.236 0 0 1 .02-.022z"/></svg>`
    }
    if (this.props.state.child) {
      childTrue.innerHTML = `<svg width="30px" height="30px" viewBox="0 0 16 16" className="bi bi-check" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10.97 4.97a.75.75 0 0 1 1.071 1.05l-3.992 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.236.236 0 0 1 .02-.022z"/></svg>`
    }

    let spouseNameDiv = document.getElementById('spouseNameDiv')
    for (let i = 0; i < 43; i++) {
      spouseNameDiv.innerHTML += `<div id="spouseNameDiv${i}" className="box"></div>`
    }
    if (spouseName) {
    ...
    for (let i = 0; i < 14; i++) {
      if (i !== 6 || i !== 9) {
        spouseNricDiv.innerHTML += `<div id="spouseNricDiv${i}" className="box"></div>`
      }
    }
    if (spouseNric) {
      ...
      for (let i = 0; i < 14; i++) {
        if (i === 6) {
          ...
          document.getElementById(`spouseNricDiv${i}`).innerHTML = spouseNric[j]
          j = j + 1
        }
      }
    }
    ...
    if (spouseBirthDate) {
      for (let i = 0; i < 10; i++) {
        spouseBirthDateDiv.innerHTML += `<div id="spouseBirthDateDiv${i}" className="box"></div>`
      }
    ...
    if (childs !== 0) {
      ...
      for (let i = 0; i < 2; i++) {
        if (childs.length === 1 && i === 0) {
          noOfChilds.innerHTML += `<div id="noOfChilds${i}" className="box">0</div>`
          noOfChilds.innerHTML += `<div id="noOfChilds${i + 1}" className="box">${
            childs[0]
            }</div>`
        } else if (childs.length > 1) {
          noOfChilds.innerHTML += `<div id="noOfChilds${i}" className="box">${childs[i]}</div>`
        }
      }
    } else {
      for (let i = 0; i < 2; i++) {
        noOfChilds.innerHTML += `<div id="noOfChilds${i}" className="box"></div>`
      }
    }
    ...
    if (childs !== 0) {
      for (let i = 0; i < childs; i++) {
        ...
        <td id="childTable${i}" className='name'>${
      ...
      for (let i = 0; i < 4; i++) {
        childTable.innerHTML += `<tr>
          <td id="childTable${i}" className='name'></td>
          <td></td>
          </tr>`
      }
    }
    ...
    for (let i = 0; i < 38; i++) {
      accountHolderNameDiv.innerHTML += `<div id="accountHolderNameDiv${i}" className="box"></div>`
    }
    ...
    if (debitCard) {
      debitCardDiv.innerHTML = `<svg width="30px" height="30px" viewBox="0 0 16 16" className="bi bi-check" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10.97 4.97a.75.75 0 0 1 1.071 1.05l-3.992 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.236.236 0 0 1 .02-.022z"/></svg>`
    }
    if (visa) {
      visaDiv.innerHTML = `<svg width="30px" height="30px" viewBox="0 0 16 16" className="bi bi-check" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10.97 4.97a.75.75 0 0 1 1.071 1.05l-3.992 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.236.236 0 0 1 .02-.022z"/></svg>`
    }
    if (masterCard) {
      masterCardDiv.innerHTML = `<svg width="30px" height="30px" viewBox="0 0 16 16" className="bi bi-check" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10.97 4.97a.75.75 0 0 1 1.071 1.05l-3.992 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.236.236 0 0 1 .02-.022z"/></svg>`
    }
    if (rhb) {
      rhbDiv.innerHTML = `<svg width="30px" height="30px" viewBox="0 0 16 16" className="bi bi-check" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10.97 4.97a.75.75 0 0 1 1.071 1.05l-3.992 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.236.236 0 0 1 .02-.022z"/></svg>`
    }
    if (mayBank) {
      mayBankDiv.innerHTML = `<svg width="30px" height="30px" viewBox="0 0 16 16" className="bi bi-check" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10.97 4.97a.75.75 0 0 1 1.071 1.05l-3.992 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.236.236 0 0 1 .02-.022z"/></svg>`
    }
    ...
    for (let i = 0; i < 16; i++) {
      issuingBankDiv.innerHTML += `<div id="issuingBankDiv${i}" className="box"></div>`
    }
    if (issuingBank) {
    ...
    for (let i = 0; i < 16; i++) {
      cardNoDiv.innerHTML += `<div id="cardNoDiv${i}" className="box"></div>`
    }
    if (cardNo) {
        ...
        <div className='page4'>
          <div className='page4-div'>
            ...
            <div className="Notice">
              <p className="underLine"><span className="bold">Notice</span> / <i> Notis </i></p>
              <p>
                For all intents and purpose where there is a conflict or ambiguity as to the meaning in the Bahasa Malaysia provision, it is hereby agreed that
                the English version shall prevail.
                            </p>
              <p>
                <i>
                  Bagi setiap tujuan dan maksud sekiranya terdapat konflik atau kekaburan berkenaan makna di dalam peruntukan Bahasa Malaysia, adalah
                  dipersetujui bahawa versi Bahasa Inggeris akan digunakan.
    </i>
              </p>
            </div>
