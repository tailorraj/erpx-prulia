                            ...
                            <p>You have registered previously</p>
                            {
                                this.state.regs.map(reg =>
                                    <div key={reg.name}>
                                        ...
                                        <div>
                                            <p>Application status: <span className="highlight">{reg.application_status}</span></p>
                                            {reg.approval_date && <p>Approval date: <span className="highlight">{reg.approval_date}</span></p>}
                                        </div>
                                    </div>
                                )
                            }
