sap.ui.define([
	...
	return Controller.extend("com.erpx.site.prulia.PRULIA.controller.PresidentMessage", {
		...
		onInit: function () {
			...
			oRouter.getRoute("PresidentMessage").attachPatternMatched(this._onObjectMatched, this);
		},
